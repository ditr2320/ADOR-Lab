...
dataSetChange$mother_age <- dataSet6m$mother_age
dataSetChange$m_ener_Mom <- dataSet6m$m_ener_Mom 
dataSetChange$exercise_r <- dataSet6m$exercise_r
dataSetChange$SES_r <- dataSet6m$SES_r
...
for(taxa in taxaLevels)
{
  ...
  taxaMeta <- merge(dataSetChange,myT5,by="dyad_id")
