...
for(j in seq(1:length(outcomes))) 
{
    ...
    
  {
    ...
    adjP0exposureList[[length(adjP0exposureList)+1]] <- p.adjust(pVal0Exposure,method = "BH",AdjustmentFactor) 
    ...
    adjP1exposureList[[length(adjP1exposureList)+1]] <- p.adjust(pVal1Exposure,method = "BH",AdjustmentFactor)
    ...
    adjP2exposureList[[length(adjP2exposureList)+1]] <- p.adjust(pVal2Exposure,method = "BH",AdjustmentFactor)
    ...
    adjP3exposureList[[length(adjP3exposureList)+1]] <- p.adjust(pVal3Exposure,method = "BH",AdjustmentFactor)
    ...
    adjP4exposureList[[length(adjP4exposureList)+1]] <- p.adjust(pVal4Exposure,method = "BH",AdjustmentFactor)
...
LM <- cbind(allExposures, 
                     Outcome0List,
                     beta0ExposureList,pVal0ExposureList,adjP0exposureList,CI0ExposureLowerList,CI0ExposureUpperList, 
                     beta1ExposureList,pVal1ExposureList,adjP0exposureList,CI1ExposureLowerList,CI1ExposureUpperList, 
                     beta2ExposureList,pVal2ExposureList,adjP0exposureList,CI2ExposureLowerList,CI2ExposureUpperList, 
                     beta3ExposureList,pVal3ExposureList,adjP0exposureList,CI3ExposureLowerList,CI3ExposureUpperList,
                     beta4ExposureList,pVal4ExposureList,adjP0exposureList,CI4ExposureLowerList,CI4ExposureUpperList,sampleSizeList) 

colnames(LM) <- c("Exposure", 
                           "Outcome",
                           "Beta Mod0","pvalueMod0","adjP0","Lower_CI_Mod0","Upper_CI_Mod0",
                           "Beta Mod1","pvalueMod1","adjP1","Lower_CI_Mod1","Upper_CI_Mod1",
                           "Beta Mod2","pvalueMod2","adjP2","Lower_CI_Mod2","Upper_CI_Mod2",
                           "Beta Mod3","pvalueMod3","adjP3","Lower_CI_Mod3","Upper_CI_Mod3", 
                           "Beta Mod4","pvalueMod4","adjP4","Lower_CI_Mod4","Upper_CI_Mod4","sampleSize") 
LM <- LM %>% as_tibble()
