...
ExposureNames <- c("HEI at 6-Month", "DII at 6-Month", "MDS at 6-Month")

#setting up outcomes to loop through
MaternalFactors <- c("shannon_entropy", "faith_pd", "gut_richness") 
MaternalNames <- c("BMI at 6-Month", "Shannon at 6-Month", "Faith at 6-Month", "Richness at 6-Month")
...
#write.table(LM_6,paste0(meta2,"176_6m.txt",sep=""),quote=FALSE, sep="\t",append=FALSE, col.names=TRUE, row.names=FALSE)