...
meta5 <- "/Volumes/ADORLab/HEI Study/16S Data/MM16S Processed Files for Mom and Infants 05Jan21/taxonomy/"
...
MaternalFactors <- c("BMI_change","shannon_change","faith_change", "richness_change")
baselineFactors <- c("mom_BMI", "shannon_entropy","faith_pd","gut_richness")
