...
for(j in seq(1:length(MaternalFactors)))
{
    ...
    
  {
    ...
    if(MaternalFactors[j] == "BMI_change"){
      ...
      modelForm1=as.formula("thisOutcome ~ thisExposureFactor + mother_age_baseline + baselineAdjust")
      #2) Model 2 base model + Kcal + Physical Activity 
      modelForm2=as.formula("thisOutcome ~ thisExposureFactor + mother_age_baseline + baselineAdjust + aExercise")
      #3) Model 3 base model + Kcal + Physical Activity + SES 
      modelForm3=as.formula("thisOutcome ~ thisExposureFactor + mother_age_baseline + baselineAdjust + aExercise + SES_index_final")
      ...
      #1) Model 1 base model + Kcal
      modelForm1=as.formula("thisOutcome ~ thisExposureFactor + mother_age_baseline + aBMI + baselineAdjust ")
      #2) Model 2 base model + Kcal + Physical Activity 
      modelForm2=as.formula("thisOutcome ~ thisExposureFactor + mother_age_baseline + aBMI + baselineAdjust + aExercise")
      #3) Model 3 base model + Kcal + Physical Activity + SES 
      modelForm3=as.formula("thisOutcome ~ thisExposureFactor + mother_age_baseline + aBMI + baselineAdjust + aExercise + SES_index_final")
