...
meta6 <- "/Volumes/ADORLab/HEI Study/16S Data/study_11908_121420-111241/BIOM/62060 deblur reference hit table/"
...
sub <- na.omit(combinedSub) #128 Sample Size 
#independent t -test 
...
t.test(FBratio ~ MDS2category, sub)

write.table(sub,paste0(meta2,"/taxa2_alpha_20June2021.txt",sep=""),quote=FALSE, sep="\t",append=FALSE, col.names=TRUE, row.names=FALSE)
