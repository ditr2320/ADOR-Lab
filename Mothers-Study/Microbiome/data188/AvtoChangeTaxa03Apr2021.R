...
for(taxa in taxaLevels)
{
  ...
  write.table(allExposures,paste0(meta2,"statisticalTables/188_momChange_",taxa,"_Microbiome_lm_withCovariates.txt",sep=""),quote=FALSE, sep="\t",append=FALSE, col.names=TRUE, row.names=FALSE)
}
