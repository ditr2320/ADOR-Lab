...
variableList <- c("DII_Mom","MDS_Mom","HEI2015_TOTAL_SCORE_Mom","obesityStatus")
...
for(taxa in taxaLevels)
{
  ...
  for(variableOfInterest in variableList)
  {
    ...
    #pdf(file = paste0(meta2,"plots/microbiome_",taxa,"_",variableOfInterest,"_lm_withCovariates.pdf",sep=""))
  ...
  #write.table(allExposures,paste0(meta2,"statisticalTables/momBaseline_",taxa,"_Microbiome_lm_withCovariates.txt",sep=""),quote=FALSE, sep="\t",append=FALSE, col.names=TRUE, row.names=FALSE)
}
