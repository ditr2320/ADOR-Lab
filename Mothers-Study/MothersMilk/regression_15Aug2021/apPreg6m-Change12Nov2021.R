...
exposure <- read.delim(paste0(meta2,"apData12Nov2021.txt"), header=TRUE)
dataSet <- exposure
...
dataSetAv$TotNO2_Preg_6m_weighted <- dataSet1m$TotNO2_Preg_6m_weighted
dataSetAv$TotO3_24h_Preg_6m_weighted <- dataSet1m$TotO3_24h_Preg_6m_weighted
dataSetAv$TotO3_8h_Preg_6m_weighted <- dataSet1m$TotO3_8h_Preg_6m_weighted
dataSetAv$TotO3_1h_Preg_6m_weighted<- dataSet1m$TotO3_1h_Preg_6m_weighted
dataSetAv$TotPM25_Preg_6m_weighted<- dataSet1m$TotPM25_Preg_6m_weighted
dataSetAv$TotPM10_Preg_6m_weighted<- dataSet1m$TotPM10_Preg_6m_weighted
metadata <- dataSetAv
...
ExposureFactors <- c("TotNO2_Preg_6m_weighted","TotO3_24h_Preg_6m_weighted","TotO3_8h_Preg_6m_weighted","TotO3_1h_Preg_6m_weighted","TotPM25_Preg_6m_weighted","TotPM10_Preg_6m_weighted")
ExposureNames<- c("TotNO2_Preg_6m_weighted","TotO3_24h_Preg_6m_weighted","TotO3_8h_Preg_6m_weighted","TotO3_1h_Preg_6m_weighted","TotPM25_Preg_6m_weighted","TotPM10_Preg_6m_weighted")
